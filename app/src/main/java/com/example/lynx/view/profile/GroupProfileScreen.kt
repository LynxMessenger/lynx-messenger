...
import com.example.lynx.view.profile.components.group.GroupProfileSettingsView
import com.example.lynx.view.profile.components.group.GroupProfileView
                ...
                Row(
                    ...
                    Image(
                        ...
                        modifier = Modifier
                            .padding(start = 16.dp)
                            .size(20.dp)
                            .clickable { navController.navigate("GroupChatScreen/${groupUuid}") },
